...
export function IntroOverlay() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-cyan-500/30 to-transparent pointer-events-none animate-scan-laser" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(3,7,18,0.2)_30%,rgba(3,7,18,0.85)_95%)] pointer-events-none" />

      <header className="w-full flex flex-col md:flex-row gap-4 justify-between items-center pointer-events-auto bg-slate-950/65 border border-slate-800/40 backdrop-blur-xl px-6 py-3 rounded-2xl relative shadow-[0_15px_30px_rgba(0,0,0,0.4)]">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/50 backdrop-blur-[3px] pointer-events-auto">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button
                  onClick={startARMode}
                  className="flex flex-col text-left p-6 rounded-2xl bg-slate-950/40 border border-slate-800/80 hover:border-cyan-500/50 hover:shadow-[0_0_20px_rgba(6,182,212,0.15)] transition-all duration-300 group relative overflow-hidden active:scale-[0.98] flex-1 justify-between h-full"
                >
                  ...
                  <div>
                    ...
                    <p className="text-[9.5px] text-slate-400 font-light leading-relaxed mt-2">
                    ...
                    <div className="space-y-2 mt-4 pt-4 border-t border-slate-900/60 text-[8.5px] font-mono text-slate-400">
                      ...
                      <div className="flex justify-between">
                        <span><span className="text-slate-500 uppercase">Hardware:</span> <strong className="text-slate-300">Webcam</strong></span>
                        <span><span className="text-slate-500 uppercase">Diff:</span> <strong className="text-slate-300">Intermediate</strong></span>
                      </div>
                    </div>
                  </div>
                ...
                <button
                  ...
                  className="flex flex-col text-left p-6 rounded-2xl bg-blue-950/10 border-2 border-blue-500/40 hover:border-blue-500/80 hover:shadow-[0_0_25px_rgba(59,130,246,0.25)] transition-all duration-300 group relative overflow-hidden active:scale-[0.98] flex-1 justify-between h-full"
                >
                  ...
                  <div>
                    ...
                    <p className="text-[9.5px] text-slate-300 font-light leading-relaxed mt-2">
              ...
              <div className="flex gap-3 items-start p-4 bg-amber-950/10 border border-amber-500/20 rounded-2xl text-[9.5px] text-amber-300 leading-relaxed relative overflow-hidden">
                ...
                <ClipboardList className="w-5 h-5 text-amber-500 shrink-0 mt-0.5 animate-pulse" />
